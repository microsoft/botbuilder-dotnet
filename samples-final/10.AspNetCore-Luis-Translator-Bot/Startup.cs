    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddBot<LuisTranslatorBot>(options =>
            {
                ...
                string translatorKey = "<your translator key here>";
                ...
                middleware.Add(new TranslationMiddleware(new string[] { "en" }, translatorKey, patterns, TranslatorLocaleHelper.GetActiveLanguage, TranslatorLocaleHelper.CheckUserChangedLanguageOrLocale));
