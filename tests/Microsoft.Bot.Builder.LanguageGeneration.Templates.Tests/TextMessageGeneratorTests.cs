...
namespace Microsoft.Bot.Builder.Dialogs.Tests
{
    ...
    public class TextMessageGeneratorTests
    {
        ...
        public async Task TestInline()
        {
            ...
            var mg = new TextActivityGenerator();
    ...
    buttons=Option 1| Option 2| Option 3]";
            var gen = new TextActivityGenerator();
            var activity = await gen.CreateActivityFromText(text, data: null, turnContext: null, languageGenerator: null);
