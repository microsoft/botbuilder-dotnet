...
namespace Microsoft.Bot.Streaming.UnitTests.Streaming
{
#pragma warning disable IDE0017
    ...
    public class StreamingRequestHandlerTests
    {
        ...
        {
            var s = new DirectLineAdapter(onTurnError: null, new MockBot(), transportServer: new MockStreamingTransportServer());
            Assert.IsNotNull(s);
        }
        ...
        {
            var s = new DirectLineAdapter(onTurnError: null, new MockBot(), transportServer: new MockStreamingTransportServer());
            Assert.IsNotNull(DirectLineAdapter.GetUserAgent());
        }
        ...
        public void StreamingRequestHandler_UserAgent_Matches_Standard_Format()
        {
            ...
            Assert.AreEqual(DirectLineAdapter.GetUserAgent(), userAgentHeader.ToString());
        }
        ...
        {
            var s = new DirectLineAdapter(onTurnError: null, bot: new MockBot() { ThrowDuringOnTurnAsync = true }, transportServer: new MockStreamingTransportServer());
        ...
        public async Task StreamingRequestHandler_ProcessRequestAsync_PostMessages_WithOneBotError_Recovers()
        {
            ...
            var s = new DirectLineAdapter(onTurnError: null, bot: bot, transportServer: new MockStreamingTransportServer());
