...
namespace Microsoft.Bot.Builder.IntegrationTests.Connector
{
    ...
    public class JwtTokenValidationTests
    {
        ...
        /// </summary>
        [TestMethod]
        public async Task Channel_MsaHeader_Valid_ServiceUrlShouldBeTrusted()
        {
            string header = $"Bearer {await new MicrosoftAppCredentials("2cd87869-38a0-4182-9251-d056e8f0ac24", "2.30Vs3VQLKt974F").GetTokenAsync()}";
            var credentials = new SimpleCredentialProvider("2cd87869-38a0-4182-9251-d056e8f0ac24", string.Empty);
        ...
        /// </summary>
        [TestMethod]
        public async Task Channel_MsaHeader_Invalid_ServiceUrlShouldNotBeTrusted()
        {
            string header = $"Bearer {await new MicrosoftAppCredentials("2cd87869-38a0-4182-9251-d056e8f0ac24", "2.30Vs3VQLKt974F").GetTokenAsync()}";
        ...
        /// </summary>
        [TestMethod]
        public async Task Channel_AuthenticationDisabled_ServiceUrlShouldNotBeTrusted()
        {
            var header = string.Empty;
            var credentials = new SimpleCredentialProvider();
