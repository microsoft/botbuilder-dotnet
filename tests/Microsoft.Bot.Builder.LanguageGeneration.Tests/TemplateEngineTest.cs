...
namespace Microsoft.Bot.Builder.AI.LanguageGeneration.Tests
{
    ...
    public class TemplateEngineTest
    {
        ...
        {
            var engine = TemplateEngine.FromFile(GetExampleFilePath("switchcase.lg"));
        ...
        {
            var engine = TemplateEngine.FromFile(GetExampleFilePath("CaseInsensitive.lg"));
            var alarms = new[]
            {
                new
                {
        ...
        {
            var emptyEngine = TemplateEngine.FromText(content: String.Empty, name: "test", importResolver: null);
        ...
        public void TestMultipleLgFiles()
        {
            ...
            var ex = Assert.ThrowsException<Exception>(() => TemplateEngine.FromFile(file123[0]));
            ...
            var engine = TemplateEngine.FromFiles(new string[] { file123[2], file123[1], file123[0] });
        ...
        {
            var engine = TemplateEngine.FromFile(GetExampleFilePath("import.lg"));
