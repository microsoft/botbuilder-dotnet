...
namespace Microsoft.Bot.Builder.AI.Luis.Tests
{
    public class LuisApplicationTests
    {
        ...
        public void ListApplicationFromLuisEndpointBadArguments()
        {
            ...
            Assert.Throws<ArgumentException>(() => new LuisApplication("https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/b31aeaf3-3511-495b-a07f-571fc873214b?verbose=true&timezoneOffset=-360&q="));
