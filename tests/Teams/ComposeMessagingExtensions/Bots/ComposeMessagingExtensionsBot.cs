...
namespace Microsoft.BotBuilderSamples.Bots
{
    public class ComposeMessagingExtensionsBot : TeamsActivityHandler
    {
        ...
        /// <inheritdoc/>
        protected override async Task OnTeamsMessagingExtensionCardButtonClickedAsync(ITurnContext<IInvokeActivity> turnContext, JObject cardInfo, CancellationToken cancellationToken)
        {
            // this event is fired when an adaptive card, with a submit button is created by the bot, but sent to the channel by the user
