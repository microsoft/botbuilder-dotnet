...
namespace AdaptiveExpressions.Tests
{
    public class ExpressionParserTests
    {
        ...
        public static IEnumerable<object[]> Data => new[]
        {
            ...
            Test("substring('abc', -1, 1)", "a"),
            Test("substring('abc', 4, 2)", string.Empty),
            Test("substring('abc', 2, 5)", "c"),
            Test("substring('abc', 2, -1)", string.Empty),
            ...
            Test("subArray(createArray('H','e','l','l','o'),-1, 1)", new List<object> { "H" }),
            Test("subArray(createArray('H','e','l','l','o'),4, 2)", new List<object>()),
            Test("subArray(createArray('H','e','l','l','o'),2, 10)", new List<object> { "l", "l", "o" }),
            Test("subArray(createArray('H','e','l','l','o'),2, -1)", new List<object>()),
