...
namespace AdaptiveExpressions.Tests
{
    public class ExpressionParserTests
    {
        ...
        public static IEnumerable<object[]> Data => new[]
        {
            ...
            Test("timex.isDefinite('helloworld')", false),
            Test("timex.isDefinite('2012-12-21')", true),
            Test("timex.isDefinite('XXXX-12-21')", false),
            Test("timex.isDefinite(validFullDateTimex)", true),
            Test("timex.isDefinite(invalidFullDateTimex)", false),
            Test("timex.isTime(validHourTimex)", true),
            Test("timex.isTime(invalidHourTimex)", false),
            Test("timex.isDuration('PT30M')", true),
            Test("timex.isDuration('2012-12-21T12:30')", false),
            Test("timex.isDate('PT30M')", false),
            Test("timex.isDate('2012-12-21T12:30')", true),
            Test("timex.isTimeRange('PT30M')", false),
            Test("timex.isTimeRange(validTimeRange)", true),
            Test("timex.isDateRange('PT30M')", false),
            Test("timex.isDateRange('2012-02')", true),
            Test("timex.isPresent('PT30M')", false),
            Test("timex.isPresent(validNow)", true),
            ...
            Test("endsWith(timex.getPreviousViableDate('XXXX-07-10'), '-07-10')", true),
            Test("endsWith(timex.getPreviousViableDate('XXXX-07-10', 'Asia/Shanghai'), '-07-10')", true),
            Test("endsWith(timex.getPreviousViableDate('XXXX-02-29'), '-02-29')", true),
            Test("endsWith(timex.getPreviousViableDate('XXXX-02-29', 'Pacific Standard Time'), '-02-29')", true),
            Test("endsWith(timex.getNextViableDate('XXXX-07-10'), '-07-10')", true),
            Test("endsWith(timex.getNextViableDate('XXXX-07-10', 'Europe/London'), '-07-10')", true),
            Test("endsWith(timex.getNextViableDate('XXXX-02-29'), '-02-29')", true),
            Test("endsWith(timex.getNextViableDate('XXXX-02-29', 'America/Los_Angeles'), '-02-29')", true),
            Test("endsWith(timex.getNextViableTime('TXX:40:20'), ':40:20')", true),
            Test("endsWith(timex.getNextViableTime('TXX:40:20', 'Asia/Tokyo'), ':40:20')", true),
            Test("endsWith(timex.getNextViableTime('TXX:05:10'), ':05:10')", true),
            Test("endsWith(timex.getNextViableTime('TXX:05:10', 'Europe/Paris'), ':05:10')", true),
            Test("endsWith(timex.getPreviousViableTime('TXX:40:20'), ':40:20')", true),
            Test("endsWith(timex.getPreviousViableTime('TXX:40:20', 'Eastern Standard Time'), ':40:20')", true),
            Test("endsWith(timex.getPreviousViableTime('TXX:05:10'), ':05:10')", true),
            Test("endsWith(timex.getPreviousViableTime('TXX:05:10', 'Central Standard Time'), ':05:10')", true),
            Test("timex.resolve('T14')", "14:00:00"),
            Test("timex.resolve('T14:20')", "14:20:00"),
            Test("timex.resolve('T14:20:30')", "14:20:30"),
            Test("timex.resolve('2020-12-20')", "2020-12-20"),
            Test("timex.resolve('2020-12-20T14')", "2020-12-20 14:00:00"),
            Test("timex.resolve('2020-12-20T14:20')", "2020-12-20 14:20:00"),
            Test("timex.resolve('2020-12-20T14:20:30')", "2020-12-20 14:20:30"),
            #endregion
