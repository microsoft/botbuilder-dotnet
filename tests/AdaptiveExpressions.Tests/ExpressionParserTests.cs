...
namespace AdaptiveExpressions.Tests
{
    public class ExpressionParserTests
    {
        ...
        public static IEnumerable<object[]> DataForThreadLocale => new[]
        {
            ...
            Test("utcNow('D')", DateTime.Now.ToString("D", new CultureInfo("fr-FR"))),
            Test("getPastTime(1,'Day', 'D')", DateTime.Now.AddDays(-1).ToString("D", new CultureInfo("fr-FR"))),
            ...
            Test("getFutureTime(1, 'Year', 'D')", DateTime.Now.AddYears(1).ToString("D", new CultureInfo("fr-FR"))),
