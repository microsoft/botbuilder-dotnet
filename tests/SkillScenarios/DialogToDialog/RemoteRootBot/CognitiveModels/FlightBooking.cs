...
namespace RemoteRootBot.CognitiveModels
{
    public partial class FlightBooking: IRecognizerConvert
    {
        ...
        {
            var app = JsonConvert.DeserializeObject<RemoteRootBot.CognitiveModels.FlightBooking>(JsonConvert.SerializeObject(result, new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore }));
            Text = app.Text;
