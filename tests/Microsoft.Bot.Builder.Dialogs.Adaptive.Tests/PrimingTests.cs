...
namespace Microsoft.Bot.Builder.Dialogs.Declarative.Tests
{
    ...
    public class PrimingTests
    {
        ...
        private static RecognitionHint[] _luisParentHints = new RecognitionHint[]
        {
            ...
            new PhraseListHint("dlist", new[] { "valueParent", "synonym1", "synonym2" })
        };
    ...
    */
        ...
        private void CheckDescription(IEnumerable<RecognitionHint> description, RecognitionHint[] hints)
        {
            ...
            if (hints == null)
            {
                Assert.Equal(Array.Empty<RecognitionHint>(), actual);
            }
            else
            {
                ...
                {
                    var match = hints.FirstOrDefault(h => h.Name == hint.Name && h.Type == hint.Type);
