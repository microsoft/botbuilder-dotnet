...
{
    [TestClass]
    public class BlobsTests : StorageBaseTests
    {
        ...
        private async Task TestConversationStateBlobStorage_Method(Storage.Blobs blobs)
        {
            if (StorageEmulatorHelper.CheckEmulator())
            {
                // Arrange
        ...
        private Storage.Blobs GetStorage(bool typeNameHandlingNone = false)
        {
