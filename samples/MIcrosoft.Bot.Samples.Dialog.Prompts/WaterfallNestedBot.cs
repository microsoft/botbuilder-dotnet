...
namespace Microsoft.Bot.Samples.Dialog.Prompts
{
    public class WaterfallNestedBot : IBot
    {
        ...
        public WaterfallNestedBot()
        {
            ...
            _dialogs.Add("test-waterfall-a", new WaterfallStep[] { Waterfall1_Step1, Waterfall1_Step2 });
            _dialogs.Add("test-waterfall-b", new WaterfallStep[] { Waterfall2_Step1, Waterfall2_Step2 });
            _dialogs.Add("test-waterfall-c", new WaterfallStep[] { Waterfall3_Step1, Waterfall3_Step2 });
        }
        ...
        {
            if (args != null) await dc.Context.SendActivity($"you said '{args}'.");
