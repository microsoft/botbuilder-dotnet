...
{
    public class SmartTalkBot : IBot
    {
        public SmartTalkBot() { }

        public async Task OnTurn(ITurnContext context)
        {
            // At this point, the SmartTalk Middleware has already been run. If the incoming
            // Activity was a message, the Middleware called out to SmartTalk looking for 
            ...
            switch (context.Activity.Type)
            {
                case ActivityTypes.Message:
                    ...
                    {
                        // add app logic when Smart Talk didn't respond. 
                        await context.SendActivity("Smart Talk didn't respond.");
                    }
                ...
                case ActivityTypes.ConversationUpdate:
                    foreach (var newMember in context.Activity.MembersAdded)
                    {
                        ...
                        {
                            await context.SendActivity("Hello and welcome to the Smart talk Sample bot.");
                        }
                    }
                    break;
            }
