...
namespace Microsoft.Bot.Samples.Ai.LUIS.Dispatch
{
    ...
    public class LuisDispatchBot : IBot
    {
        ...
        private static LuisApplication luisModel1 =
            new LuisApplication("<YOUR-LUIS-APP-ID>", "<YOUR-LUIS-SUBSCRIPTION-KEY>", new System.Uri("https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/"));

        // App ID for a LUIS model named "weather"
        private static LuisApplication luisModel2 =
            new LuisApplication("YOUR-LUIS-APP-ID", "<YOUR-LUIS-SUBSCRIPTION-KEY>", new System.Uri("https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/"));
