...
namespace Microsoft.BotBuilderSamples
{
    ...
    */
    public class AdapterWithErrorHandler : CloudAdapter
    {
        ...
        public AdapterWithErrorHandler(IConfiguration configuration, IStorage storage, IHttpClientFactory httpClientFactory, ILogger<CloudAdapter> logger, ConversationState conversationState = null)
            : base(configuration, httpClientFactory: httpClientFactory, logger: logger)
        {
            Use(new TeamsSSOTokenExchangeMiddleware(storage, configuration["ConnectionName"].ToString()));
