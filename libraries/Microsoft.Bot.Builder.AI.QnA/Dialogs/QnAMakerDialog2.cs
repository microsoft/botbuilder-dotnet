...
//        {
//            var noAnswer = (this.NoAnswer != null) ? await this.NoAnswer.BindToDataAsync(dc.Context, dc.State).ConfigureAwait(false) : null;
//            var cardNoMatchResponse = (this.CardNoMatchResponse != null) ? await this.CardNoMatchResponse.BindToDataAsync(dc.Context, dc.State).ConfigureAwait(false) : null;
