...
namespace Microsoft.Bot.Builder.AI.QnA
{
    public class CardHelper
    {
        ...
        /// <param name="cardNoMatchText">No match text.</param>
        /// <returns>IMessageActivity.</returns>
        public static IMessageActivity GetPromptCard(QueryResult queryResult, string cardTitle, string cardNoMatchText)
        {
            var chatActivity = Activity.CreateMessageActivity();
            var buttonList = new List<CardAction>();

            // Add all suggestions
            foreach (var suggestion in queryResult.Questions)
            {
                buttonList.Add(
                    new CardAction()
                    {
