...
namespace Microsoft.Bot.Builder.Dialogs.Form.Events
{
    ...
    {
        [JsonConstructor]
        public OnClarifySlotValue(List<IDialog> actions = null, string constraint = null, int priority = 0, [CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
            : base(
