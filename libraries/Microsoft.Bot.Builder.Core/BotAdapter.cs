...
namespace Microsoft.Bot.Builder
{
    ...
    public abstract class BotAdapter
    {
        ...
        /// <paramref name="context"/> is null or the context's
        /// <see cref="ITurnContext.Activity"/> property is null.</exception>
        ...
        protected async Task RunPipeline(ITurnContext context, Func<ITurnContext, Task> callback = null, CancellationTokenSource cancelToken = null)
        {
            ...
            // Call any registered middleware and the callback.
