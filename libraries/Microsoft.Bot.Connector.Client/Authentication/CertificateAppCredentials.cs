...
namespace Microsoft.Bot.Connector.Client.Authentication
{
    ...
    public class CertificateAppCredentials : AppCredentials
    {
             ...
             : base(options.ChannelAuthTenant, options.CustomHttpClient, options.Logger, oAuthScope: options.OauthScope)
        {
            ...
            this._sendX5C = options.SendX5c;
            this._clientCertificate = new ClientAssertionCertificate(options.AppId, options.ClientCertificate);
            MicrosoftAppId = this._clientCertificate.ClientId;
        }
            ...
            : base(channelAuthTenant, customHttpClient, logger)
        {
            ...
            this._clientCertificate = new ClientAssertionCertificate(appId, clientCertificate);
            MicrosoftAppId = this._clientCertificate.ClientId;
        }
