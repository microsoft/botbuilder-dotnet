...
namespace Microsoft.Bot.Builder.Dialogs.Adaptive.Teams.Conditions
{
    ...
    /// </summary>
    public class OnTeamsMessagingExtensionBotMessagePreviewEdit : OnInvokeActivity
    {
        [JsonProperty("$kind")]
        public new const string Kind = "Teams.OnMessagingExtensionBotMessagePreviewEdit";

        [JsonConstructor]
        public OnTeamsMessagingExtensionBotMessagePreviewEdit(List<Dialog> actions = null, string condition = null, [CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
