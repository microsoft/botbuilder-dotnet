...
namespace Microsoft.Bot.Builder.Dialogs.Adaptive.Teams.Conditions
{
    ...
    /// </summary>
    public class OnTeamsMessagingExtensionBotMessagePreviewSend : OnInvokeActivity
    {
        [JsonProperty("$kind")]
        public new const string Kind = "Teams.OnMessagingExtensionBotMessagePreviewSend";

        [JsonConstructor]
        public OnTeamsMessagingExtensionBotMessagePreviewSend(List<Dialog> actions = null, string condition = null, [CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
