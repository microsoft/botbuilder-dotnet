...
namespace Microsoft.Bot.Builder.Dialogs.Declarative
{
    ...
    /// </summary>
    [Obsolete("Use `BotComponent` and register declarative types through adding `DeclarativeType` implementations to the IServiceCollection, for example `services.AddSingleton<DeclarativeType, MyDeclarativeType>()`.")]
