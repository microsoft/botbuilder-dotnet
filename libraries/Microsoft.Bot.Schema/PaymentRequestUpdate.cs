...
namespace Microsoft.Bot.Schema
{
    ...
    public partial class PaymentRequestUpdate
    {
        ...
        public PaymentRequestUpdate(string id = default, PaymentDetails details = default(PaymentDetails), PaymentAddress shippingAddress = default(PaymentAddress), string shippingOption = default(string))
        {
            Id = id;
            Details = details;
