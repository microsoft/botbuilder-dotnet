...
{
    /// <summary>
    /// The TextActivityGenerator implements IActivityGenerator by using ILanguageGenerator
    ...
    /// </summary>
    public class TextActivityGenerator : IActivityGenerator
    {
        // Fixed text constructor
        public TextActivityGenerator()
        {
        }
        ...
        public async Task<Activity> CreateActivityFromText(string text, object data, ITurnContext turnContext, ILanguageGenerator languageGenerator)
        {
