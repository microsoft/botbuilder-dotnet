    ...
    public class JwtTokenExtractor
    {
        ...
        public async Task<ClaimsIdentity> GetIdentityAsync(string scheme, string parameter)
        {
            ...
            catch (Exception e)
            {
                ...
                BotServiceProvider.Instance.CreateLogger().LogError($"Invalid token. {e.ToString()}");
        ...
        private async Task<ClaimsPrincipal> ValidateTokenAsync(string jwtToken)
        {
            ...
            catch (Exception e)
            {
                ...
                BotServiceProvider.Instance.CreateLogger().LogError($"Error refreshing OpenId configuration: {e}");
