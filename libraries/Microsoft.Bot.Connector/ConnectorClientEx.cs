...
namespace Microsoft.Bot.Connector
{
    ...
    public partial class ConnectorClient
    {
        ...
        /// <param name="httpClientHandler">Optional. <see cref="HttpClient"></see>/> to be used by the connector client.</param>
        /// <param name="handlers">Optional. The delegating handlers to add to the http client pipeline.</param>
        public ConnectorClient(Uri baseUri, string microsoftAppId = null, string microsoftAppPassword = null, HttpClient customHttpClient = null, params DelegatingHandler[] handlers)
            : this(baseUri, new MicrosoftAppCredentials(microsoftAppId, microsoftAppPassword), customHttpClient: customHttpClient, handlers: handlers)
        {
        }
        ...
        /// <param name="httpClientHandler">Optional. <see cref="HttpClient"></see>/> to be used by the connector client.</param>
        /// <param name="handlers">Optional. The delegating handlers to add to the http client pipeline.</param>
        public ConnectorClient(Uri baseUri, MicrosoftAppCredentials credentials, bool addJwtTokenRefresher = true, HttpClient customHttpClient = null, params DelegatingHandler[] handlers)
