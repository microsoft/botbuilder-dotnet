...
namespace Microsoft.Bot.Connector
{
    public partial class ConnectorClient
    {
        ...
        /// <param name="microsoftAppId">Optional, the Microsoft app for the bot resource.
        ...
        /// <param name="handlers">Optional, <see cref="DelegatingHandler"/> objects to add to the HTTP client pipeline.</param>
        ...
        /// </summary>
        /// <param name="baseUri">Base URI for the Connector service.</param>
        /// <param name="credentials">A <see cref="MicrosoftAppCredentials"/> object that contains the
        /// Microsoft app ID and password for your bot resource.</param>
        /// <param name="addJwtTokenRefresher">Optional.</param>
        /// <param name="handlers">Optional, <see cref="DelegatingHandler"/> objects to add to the HTTP client pipeline.</param>
