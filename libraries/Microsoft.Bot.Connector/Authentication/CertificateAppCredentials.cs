...
namespace Microsoft.Bot.Connector.Authentication
{
    ...
    public class CertificateAppCredentials : AppCredentials
    {
        ...
        private IAuthorizationHeaderProvider _tokenProvider;
        ...
        public CertificateAppCredentials(IAuthorizationHeaderProvider tokenProvider, CertificateAppCredentialsOptions options)
             : base(tokenProvider, options.ChannelAuthTenant, options.CustomHttpClient, options.Logger, oAuthScope: options.OauthScope)
        {
        ...
        public CertificateAppCredentials(IAuthorizationHeaderProvider tokenProvider, X509Certificate2 clientCertificate, string appId, string channelAuthTenant = null, HttpClient customHttpClient = null, ILogger logger = null)
            : this(tokenProvider, clientCertificate, appId, channelAuthTenant, string.Empty, false, customHttpClient, logger)
        {
        }
        ...
        /// <param name="customHttpClient">Optional <see cref="HttpClient"/> to be used when acquiring tokens.</param>
        /// <param name="logger">Optional <see cref="ILogger"/> to gather telemetry data while acquiring and managing credentials.</param>
        public CertificateAppCredentials(IAuthorizationHeaderProvider tokenProvider, X509Certificate2 clientCertificate, bool sendX5c, string appId, string channelAuthTenant = null, HttpClient customHttpClient = null, ILogger logger = null)
            : this(tokenProvider, clientCertificate, appId, channelAuthTenant, string.Empty, sendX5c, customHttpClient, logger)
        {
        }
        ...
        /// <param name="customHttpClient">Optional <see cref="HttpClient"/> to be used when acquiring tokens.</param>
        /// <param name="logger">Optional <see cref="ILogger"/> to gather telemetry data while acquiring and managing credentials.</param>
        public CertificateAppCredentials(IAuthorizationHeaderProvider tokenProvider, X509Certificate2 clientCertificate, string appId, string channelAuthTenant = null, string oAuthScope = null, bool sendX5c = false, HttpClient customHttpClient = null, ILogger logger = null)
            : base(tokenProvider, channelAuthTenant, customHttpClient, logger, oAuthScope: oAuthScope)
        {
