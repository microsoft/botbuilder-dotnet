...
namespace Microsoft.Bot.Connector.Authentication
{
    ...
    public class MicrosoftGovernmentAppCredentials : MicrosoftAppCredentials
    {
        ...
        /// </summary>
        public static new readonly MicrosoftGovernmentAppCredentials Empty = new MicrosoftGovernmentAppCredentials(null, null, null, null, null, GovernmentAuthenticationConstants.ToChannelFromBotOAuthScope);
        ...
        public MicrosoftGovernmentAppCredentials(IAuthorizationHeaderProvider tokenProvider, string appId, string password, HttpClient customHttpClient = null, ILogger logger = null, string oAuthScope = null)
            : base(tokenProvider, appId, password, customHttpClient, logger, oAuthScope)
        {
        }
        ...
        /// <param name="logger">Optional <see cref="ILogger"/> to gather telemetry data while acquiring and managing credentials.</param>
        /// <param name="oAuthScope">The scope for the token (defaults to <see cref="GovernmentAuthenticationConstants.ToChannelFromBotOAuthScope"/> if null).</param>
        public MicrosoftGovernmentAppCredentials(IAuthorizationHeaderProvider tokenProvider, string appId, string password, string channelAuthTenant, HttpClient customHttpClient = null, ILogger logger = null, string oAuthScope = null)
            : base(tokenProvider, appId, password, channelAuthTenant, customHttpClient, logger, oAuthScope)
        {
        }
