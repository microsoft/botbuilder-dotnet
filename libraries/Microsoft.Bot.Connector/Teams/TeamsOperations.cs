...
#pragma warning disable CA1801 // Review unused parameters - cannot change without breaking backwards compat.
        public async Task<HttpOperationResponse<MeetingNotificationRecipientFailureInfos>> SendMeetingNotificationMessageAsync(string meetingId, MeetingNotificationEnvelope notification, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
...
#pragma warning disable CA2000 // Dispose objects before losing scope
            var result = new HttpOperationResponse<MeetingNotificationRecipientFailureInfos>();
#pragma warning restore CA2000 // Dispose objects before losing scope
            try
            {
                ...
                if ((int)statusCode == 207)
                {
                    ...
                    try
                    {
                        result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<MeetingNotificationRecipientFailureInfos>(responseContent, Client.DeserializationSettings);
                    }
