...
namespace Microsoft.Bot.Builder.Integration.AspNet.Core
{
    ...
    /// </remarks>
    public abstract class BotFrameworkHttpClientBase : BotFrameworkClient
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BotFrameworkHttpClientBase"/> class.
        /// </summary>
        /// <param name="httpClient">A <see cref="HttpClient"/>.</param>
        /// <param name="logger">An instance of <see cref="ILogger"/>.</param>
        protected BotFrameworkHttpClientBase(HttpClient httpClient, ILogger logger = null)
        {
        ...
        protected abstract Task<AppCredentials> BuildCredentialsAsync(string appId, string oAuthScope = null);

        /// <summary>
        /// Gets the OAuth audience scope, used during token retrieval.
        /// </summary>
        /// <returns>Either https://api.botframework.com or bot app id.</returns>
        protected abstract string GetOriginatingAudience();
