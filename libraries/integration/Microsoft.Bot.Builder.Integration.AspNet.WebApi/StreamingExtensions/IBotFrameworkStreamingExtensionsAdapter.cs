...
namespace Microsoft.Bot.Builder.Integration.AspNet.WebApi.StreamingExtensions
{
    public interface IBotFrameworkStreamingExtensionsAdapter
    {
        ...
        Task<Rest.HttpOperationResponse> DeleteActivityAsync(string conversationId, string activityId, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </param>
        /// <returns>Rest.HttpOperationResponse.</returns>
        Task<Rest.HttpOperationResponse> DeleteConversationMemberAsync(string conversationId, string memberId, CancellationToken cancellationToken = default(CancellationToken));
