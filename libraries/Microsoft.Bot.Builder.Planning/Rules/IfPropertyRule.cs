...
namespace Microsoft.Bot.Builder.Planning.Rules
{
    public class IfPropertyRuleCondition
    {
        ...
        public List<IPlanningRule> Rules { get; set; }

    }

    public class IfPropertyRule : IPlanningRule
    {
        ...
        public IfPropertyRule(Func<DialogContextState, Task<bool>> expression, List<IPlanningRule> rules)
        {
        ...
        public void ElseIf(Func<DialogContextState, Task<bool>> expression, List<IPlanningRule> rules)
        {
            Conditionals.Add(new IfPropertyRuleCondition()
            {
                Expression = expression,
        ...
        public void Else(Func<DialogContextState, Task<bool>> expression, List<IPlanningRule> rules)
        {
            Conditionals.Add(new IfPropertyRuleCondition()
            {
