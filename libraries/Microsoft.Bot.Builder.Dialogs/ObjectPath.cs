...
namespace Microsoft.Bot.Builder.Dialogs
{
    ...
    public static class ObjectPath
    {
        ...
        public static bool TryGetPathValue<T>(object obj, string path, out T value)
        {
            ...
            if (!TryResolvePath(obj, ref path))
            {
                return false;
            }
        ...
        public static bool TryResolvePath(object obj, ref string propertyPath)
        {
            if (propertyPath.StartsWith("{") && propertyPath.EndsWith("}"))
            {
                ...
                return TryGetPathValue<string>(obj, propertyPath.Substring(1, propertyPath.Length - 2), out propertyPath);
            }
