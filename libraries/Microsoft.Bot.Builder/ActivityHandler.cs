...
namespace Microsoft.Bot.Builder
{
    ...
    public class ActivityHandler : IBot
    {
        ...
        /// <see cref="ActivityHandler.OnTurnAsync(ITurnContext{IConversationUpdateActivity}, CancellationToken)"/> is used.
        ...
        /// <see cref="ActivityHandler.OnEventActivityAsync(ITurnContext{IConversationUpdateActivity}, CancellationToken)"/> is used.
