...
namespace Microsoft.Bot.Builder.Adapters
{
    ...
    public class TestAdapter : BotAdapter, IUserTokenProvider
    {
        ...
        private IDictionary<UserTokenKey, string> _userTokens = new Dictionary<UserTokenKey, string>();
        private IList<TokenMagicCode> _magicCodes = new List<TokenMagicCode>();
