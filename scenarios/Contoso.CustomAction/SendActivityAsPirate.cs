...
namespace Contoso.CustomAction
{
    ...
    public class SendActivityAsPirate : Dialog
    {
        ...
        /// </summary>
        [JsonProperty("$kind")]
        public const string Kind = "Contoso.SendActivityAsPirate";

        /// <summary>
        /// Initializes a new instance of the <see cref="SendActivityAsPirate"/> class.
        /// </summary>
        /// <param name="activity"><see cref="Activity"/> to send.</param>
        /// <param name="callerPath">Optional, source file full path.</param>
        /// <param name="callerLine">Optional, line number in source file.</param>
        public SendActivityAsPirate(Activity activity, [CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
        {
        ...
        /// <param name="callerLine">Optional, line number in source file.</param>
        [JsonConstructor]
        public SendActivityAsPirate(string text = null, [CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
        {
            this.RegisterSourceLocation(callerPath, callerLine);
        ...
        public override async Task<DialogTurnResult> BeginDialogAsync(DialogContext dc, object options = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            activity.Text = $"All hands Hoay! {activity.Text}";
