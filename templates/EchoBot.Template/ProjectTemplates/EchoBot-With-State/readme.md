...
### Visual studio
- Navigate to the samples folder and open EchoBot-With-State.csproj in Visual studio 
- Hit F5

### Visual studio code
- open samples\3.EchoBot-With-State folder
- Bring up a terminal, navigate to samples\3.EchoBot-With-State folder
- type 'dotnet run'
...
- File -> Open bot and navigate to samples\3.EchoBot-With-State folder
